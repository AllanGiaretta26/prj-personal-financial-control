...
### Alterado
- `README.md` e `ARCHITECTURE.md` atualizados para o estado de produção: seção **Ambiente online** (URLs do frontend no Cloudflare Pages, da API e do Swagger no Render), seção de **Deploy** (Docker), e exemplos de variáveis com `sslmode=require` e CORS com curinga de subdomínio.
